...
addFields.forEach((field, index) => {
  test(`Test Case ${index + 1}`, async ({ page }) => {
    ...
    await page
      .locator(
        "div:nth-child(4) > div > .select > .select__control > .select__indicators > .select-dropdown-indicator"
      )
      .click();
    ...
    await page
      .locator("div")
      .filter({ hasText: /^\*Data TypeData Type$/ })
      .locator("svg")
      .click();
  });
  ...
  test("addfieldvalueboolean-false", async ({ page }) => {
    ...
    await page
      .getByRole("row", { name: "fieldtest20240110 boolean" })
      .locator("path")
      .first()
      .click();
  ...
  test("createfield-string", async ({ page }) => {
    ...
    await page
      .locator("div")
      .filter({ hasText: /^Field GroupField Group$/ })
      .locator("svg")
      .click();
  ...
  test("createFieldOpentext", async ({ page }) => {
    ...
    await page
      .locator("div")
      .filter({ hasText: /^\*Field TypeField Type$/ })
      .locator("svg")
      .click();
